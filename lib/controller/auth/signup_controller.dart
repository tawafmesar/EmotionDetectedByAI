...
import 'package:emotiondetectedbyai/data/datasource/remote/auth/signup.dart';
    ...
    if (StatusRequest.success == statusRequest) {
      if (response['status'] == "success") {
        ...
        Get.offNamed(AppRoute.successSignUp  ,arguments: {
          "emailinit" : email.text,
          "passwordinit" : password.text

        });
      } else {
        Get.defaultDialog(title: "Alert", middleText: "Please make sure, the email or phone number already exists");
